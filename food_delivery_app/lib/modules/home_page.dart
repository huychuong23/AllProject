...
import 'package:food_delivery_app/components/cuisine_items_card.dart';
import 'package:food_delivery_app/components/home_title.dart';
import 'package:food_delivery_app/components/nearby_items_card.dart';
import 'package:food_delivery_app/components/popular_items_card.dart';
import 'package:food_delivery_app/models/cuisineItems.dart';
import 'package:food_delivery_app/models/nearbyItems.dart';
import 'package:food_delivery_app/models/popularItems.dart';
...
class HomePage extends StatelessWidget {
  List<CuisineItems> cuisineItems = [
    ...
    CuisineItems(
        ...
        image: "assets/images/mexican.jpeg"),
  ];
  List<PopularItems> popularItems = [
    PopularItems(
        text: "Thai Me Up Restaurant &\nBrewery",
        image: "assets/images/brewery.jpeg"),
    PopularItems(
        text: "Tequila Mackingbir\nGreenpoint",
        image: "assets/images/greenpoint.jpeg"),
  ];
  List<NearByItems> nearbyItems = [
    NearByItems(
        text: "Sotto || Ponte Pizza\nPasta Tradizionali",
        image: "assets/images/ponte_pizza.jpeg"),
    NearByItems(
        text: "Delicious Pizza & Pasta\nTraditionaly",
        image: "assets/images/delicious.jpeg"),
    NearByItems(
        text: "Delicious Pizza & Pasta\nTraditionaly",
        image: "assets/images/delicious.jpeg"),
  ];
